...
function monochrome_custom_footer_logo() {
	...
	$footer_logo_link = sprintf( __(' <div class="footer-distributed">
	
	<div class="footer-left">

				<img class="imagen_footer" src="https://polishprotection.com/wp-content/uploads/2020/06/cropped-PolishMallorca_logo-2-1.jpeg">


				<p class="footer-company-name">Copyright @ 2020 - Polish Protection </p>
			</div>
			...
			<div class="footer-center">
				...
				<div>
					...
					<p>+34 633 178 820 <br>+34 652 434 435</p>
				</div>

				<div>
					<i class="fa fa-envelope"></i>
					<p><a href="mailto:polishmallorca@gmail.com">polishmallorca@gmail.com</a></p>
				</div>


				<div>
				<i class="fab fa-instagram"></i>
					<p><a class="instagram" href="https://www.instagram.com/polishprotection">Instagram</a></p>
				</div>
			...
			<div class="footer-right">
				...
				<p class="footer-company-about">
					...
					Polish & Protection es una empresa en expansión con sede en Palma de Mallorca. Ofrecemos una aplicación de primera clase de protección cerámica y polímero que proporciona rendimiento, protección y durabilidad para el exterior e interior de los yates.
				</p>
...
, trailingslashit( home_url() ), esc_url( $footer_logo ), get_bloginfo( 'name' ) );
